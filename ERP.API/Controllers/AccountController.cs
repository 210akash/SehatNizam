...
namespace ERP.API.Controllers
{
    ...
    public class AccountController : ControllerBase
    {
        ...
        public async Task<ActionResult<List<GetAccount>>> GetGroupAccount()
        {
            try
            {
                return await mediator.Send(new GetGroupAccountQuery());
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpPost]
        [Route("GetAccountByAccountFlow")]
        public async Task<ActionResult<List<GetAccountByAccountFlow>>> GetAccountByAccountFlow(GetAccountByAccountFlowQuery getAccountByAccountFlowQuery)
        {
            try
            {
                return await this.mediator.Send(getAccountByAccountFlowQuery);
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
