    ...
    public class AuthController : BaseController
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterCommand command)
        {
            ...
            if (string.IsNullOrEmpty(result.Error) && result.Succeeded)
            {
                ...
                return this.Result(ResponseStatus.OK, true, "Register User Succeeded");
            }
        ...
        [HttpPost]
        [Route("GetAll")]
        public async Task<ActionResult<Tuple<List<GetAllUsers>, long>>> GetAll(GetAllUsersQuery getAllUsersQuery)
        {
            try
            {
                return await this.mediator.Send(getAllUsersQuery);
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("GetById")]
        public async Task<ActionResult<GetAllUsers>> GetById(Guid UserId)
        {
            try
            {
                return await this.mediator.Send(new GetByIdQuery(UserId));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("GetByName")]
        public async Task<ActionResult<List<GetAllUsers>>> GetByName(string Name)
        {
            try
            {
                return await this.mediator.Send(new GetByNameQuery(Name));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("GetAllByRole")]
        public async Task<ActionResult<List<GetUsers>>> GetAllByRole(string role)
        {
            try
            {
                return await this.mediator.Send(new GetAllUsersByRoleQuery(role));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("GetRoleById")]
        public async Task<ActionResult<GetRoles>> GetById(string id)
        {
            try
            {
                return await this.mediator.Send(new GetRoleByIdQuery(id));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpPost]
        [Route("SaveRole")]
        public async Task<IActionResult> Save(SaveRoleCommand command)
        {
            try
            {
                if (!ModelState.IsValid)
        ...
        [HttpGet]
        [Route("GetRoleByName")]
        public async Task<ActionResult<List<GetRoles>>> GetRoleByName(string Name)
        {
            try
            {
                return await mediator.Send(new GetRoleByNameQuery(Name));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("DeleteRole")]
        public async Task<ActionResult<long>> DeleteRole(string id)
        {
            try
            {
                var result = await this.mediator.Send(new DeleteRoleQuery(id));
                if (result == (long)ResponseStatus.Conflict)
                {
                    return this.Result(ResponseStatus.Conflict, null, "Role is used!");
                }
                else if (result == (long)ResponseStatus.Error)
                {
                    return this.Result(ResponseStatus.Error, null, "Error Deleting Role!");
                }
        ...
        public async Task<IActionResult> AdminChangePassword([FromBody] ChangePasswordParameterModel model)
        {
            try
            {
                if (!ModelState.IsValid)
                ...
                else
                {
                    ...
                    {
                        var errorDescriptions = AddPassword.Errors.Select(e => e.Description).ToList();
                        var errorString = string.Join(", ", errorDescriptions);
                        return this.Result(ResponseStatus.ValidationFailed, false, errorString);
                    }
                }
            }
            catch (Exception ex)
        ...
        [HttpGet]
        [Route("DeleteUser")]
        public async Task<ActionResult<long>> DeleteUser(string id)
        {
            try
            {
                var result = await this.mediator.Send(new DeleteUserQuery(id));
                if (result == (long)ResponseStatus.Conflict)
                {
                    return this.Result(ResponseStatus.Conflict, null, "User is used!");
                }
                else if (result == (long)ResponseStatus.Error)
                {
                    return this.Result(ResponseStatus.Error, null, "Error Deleting User!");
                }
                else if (result == (long)ResponseStatus.OK)
                {
                    return this.Result(ResponseStatus.OK, null, "Successfully Deleted!");
        ...
        [HttpPost]
        [Route("GetAllSaleUsers")]
        public async Task<ActionResult<Tuple<List<GetAllUsers>, long>>> GetAllSaleUsers(GetAllSaleUsersQuery getAllSaleUsersQuery)
        {
            try
            {
                return await this.mediator.Send(getAllSaleUsersQuery);
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("GetAllRolesByDepartment")]
        public async Task<ActionResult<List<GetRoles>>> GetAllRolesByDepartment(long departmentId)
        {
            try
            {
                return await mediator.Send(new GetAllRolesByDepartmentQuery(departmentId));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        [HttpGet]
        [Route("UpdateSelectedWarehouse")]
        public async Task<ActionResult<string>> UpdateSelectedWarehouse(long ProjectId)
        {
            try
            {
                var jwtToken = await mediator.Send(new UpdateSelectedWarehouseQuery(ProjectId));
        ...
        [HttpPost]
        [Route("RegisterMobileDevice")]
        public async Task<IActionResult> RegisterMobileDevice(RegisterMobileDeviceCommand command)
        {
            try
            {
                await this.mediator.Send(command);
