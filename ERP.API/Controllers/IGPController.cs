...
namespace ERP.API.Controllers
{
    ...
    public class IGPController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("ApproveIGP")]
        public async Task<ActionResult<bool>> ApproveIGP(long id)
        {
            try
            {
                return await this.mediator.Send(new ApproveIGPQuery(id));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        public async Task<ActionResult<List<GetPurchaseOrder>>> GetPendingPurchaseOrders(long PurchaseOrderId)
        {
            try
            {
        ...
        public async Task<ActionResult<List<GetPurchaseOrderDetail>>> GetPendingPOItems(long PurchaseOrderId,long IGPId)
        {
            try
            {
                return await mediator.Send(new GetPendingPOItemsQuery(PurchaseOrderId, IGPId));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
