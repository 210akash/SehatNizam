...
namespace ERP.API.Controllers
{
    ...
    public class PurchaseOrderController : ControllerBase
    {
        ...
        [HttpGet]
        [Route("RejectPurchaseOrder")]
        public async Task<ActionResult<bool>> RejectPurchaseOrder(long id, string StatusRemarks)
        {
            try
            {
                return await this.mediator.Send(new RejectPurchaseOrderQuery(id, StatusRemarks));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        public async Task<ActionResult<bool>> CancelPurchaseOrder(long id, string StatusRemarks)
        {
            try
            {
                return await this.mediator.Send(new CancelPurchaseOrderQuery(id, StatusRemarks));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
        ...
        public async Task<ActionResult<Tuple<long, long, long, long, long>>> GetPurchaseOrderCount(GetPurchaseOrderCountQuery getLeadsCountByUserProjectQuery)
        {
            try
            {
        ...
        public async Task<ActionResult<List<GetDropDown>>> GetPendingDemand(GetPendingDemandQuery PurchaseDemandId)
        {
            try
            {
                return await mediator.Send(PurchaseDemandId);
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
