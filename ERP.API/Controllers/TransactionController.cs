...
namespace ERP.API.Controllers
{
    ...
    public class TransactionController : ControllerBase
    {
        ...
        public async Task<ActionResult<string>> GetTransactionCode(long VoucherTypeId, DateTime VoucherDate)
        {
            try
            {
                string code =  await mediator.Send(new GetTransactionCodeQuery(VoucherTypeId, VoucherDate));
        ...
        public async Task<ActionResult<bool>> RejectTransaction(long id)
        {
            try
            {
                return await this.mediator.Send(new RejectTransactionQuery(id));
            }
            catch (Exception ex)
            {
                return this.Result(ResponseStatus.Error, null, ex.Message);
