namespace ERP.Mediator.AutoMapper.Configuration
{
    ...
    public class AutoMapperConfiguration : Profile
    {
       ...
       .ReverseMap();
            CreateMap<Triage, GetTriage>()
    .ForMember(d => d.Patient,
        opt => opt.MapFrom(s => s.Appointment.Patient))
    .ReverseMap();
            ...
            this.CreateMap<TriagePriority, GetTriagePriority>().ReverseMap();
            CreateMap<PriorityLevel, GetTriagePriority>().ReverseMap();
            ...
            this.CreateMap<RadiologyType, GetRadiologyType>().ReverseMap();
            this.CreateMap<RadiologyType, SaveRadiologyTypeCommand>().ReverseMap();
            ...
            CreateMap<AdmissionPackageDetail, SaveAdmissionPackageDetailCommand>().ReverseMap();
            ...
            CreateMap<BloodUnit, GetBloodUnit>()
                ...
                .ForMember(d => d.BloodDonation, opt => opt.MapFrom(s => s.BloodDonation));
