...
{
    public class RegisterMobileDeviceHandler : BaseHandler, IRequestHandler<RegisterMobileDeviceCommand, IdentityResponse>
    {
        ...
        public RegisterMobileDeviceHandler(IMapper mapper, IUnitOfWork unitOfWork, UserManager<AspNetUsersModel> userManager,
        ...
        public async Task<IdentityResponse> Handle(
      RegisterMobileDeviceCommand request,
      CancellationToken cancellationToken)
        {
            var result = new IdentityResponse();

            var user = await unitOfWork.Repository<AspNetUsers>()
            ...
            bool IsRegisterDeviceForMobile = request.IsMobileDeviceRegister;

            // Update the tracked Identity user
