...
{
    public class GetComparativeStatementCountHandler : IRequestHandler<GetComparativeStatementCountQuery, Tuple<long, long, long, long>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly SessionProvider sessionProvider;
        public GetComparativeStatementCountHandler(IUnitOfWork unitOfWork, SessionProvider sessionProvider)
        {
            this.unitOfWork = unitOfWork;
            this.sessionProvider = sessionProvider;
        }

        public async Task<Tuple<long, long, long, long>> Handle(GetComparativeStatementCountQuery request, CancellationToken cancellationToken)
        {
            ...
            var entity = unitOfWork.Repository<Entities.Models.ComparativeStatement>().GetPagingWhereAsNoTrackingAsync(predicate, null, null, null, null, null);
            int Created = 0;
            if (roles.Contains("Purchase Manager"))
            {
