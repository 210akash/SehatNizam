...
{
    public class ProcessEmployeeLeaveHandler : IRequestHandler<ProcessEmployeeLeaveCommand, long>
    {
        private readonly IMapper mapper;
        private readonly IUnitOfWork unitOfWork;
        private readonly SessionProvider sessionProvider;

        public ProcessEmployeeLeaveHandler(IMapper mapper, IUnitOfWork unitOfWork, SessionProvider sessionProvider)
        {
            this.mapper = mapper;
        ...
        async Task<long> IRequestHandler<ProcessEmployeeLeaveCommand, long>.Handle(ProcessEmployeeLeaveCommand request, CancellationToken cancellationToken)
        {
