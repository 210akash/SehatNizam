...
{
    public class SaveAdmissionHandler : IRequestHandler<SaveAdmissionCommand, long>
    {
        private readonly IMapper mapper;
        private readonly IUnitOfWork unitOfWork;
        private readonly SessionProvider sessionProvider;
        public SaveAdmissionHandler(IMapper mapper, IUnitOfWork unitOfWork, SessionProvider sessionProvider)
        {
            this.mapper = mapper;
        ...
        public async Task<long> Handle(SaveAdmissionCommand request, CancellationToken cancellationToken)
        {
        ...
        private async Task<long> CreateAppointmentAsync(SaveAdmissionCommand request, CancellationToken cancellationToken)
        {
        ...
        private async Task<long> GetOrCreatePatientAsync(SaveAdmissionCommand request)
        {
        ...
        //private async Task<long> UpdateAppointmentAsync(SaveAdmissionCommand request, CancellationToken cancellationToken)
        //{
        //    if (request.AppointmentStatusId == 1)
        //    {
        //        var patient =
