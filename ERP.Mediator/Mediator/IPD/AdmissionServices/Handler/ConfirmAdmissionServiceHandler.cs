...
{
    public class ConfirmAdmissionServiceHandler : IRequestHandler<ConfirmAdmissionServiceCommand, Tuple<long, string>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly SessionProvider sessionProvider;
        public ConfirmAdmissionServiceHandler(IUnitOfWork unitOfWork, SessionProvider sessionProvider)
        {
            this.unitOfWork = unitOfWork;
            this.sessionProvider = sessionProvider;
        }

        public async Task<Tuple<long, string>> Handle(ConfirmAdmissionServiceCommand request, CancellationToken cancellationToken)
        {
            int check = 0;
