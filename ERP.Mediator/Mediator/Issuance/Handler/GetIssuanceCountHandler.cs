...
{
    public class GetIssuanceCountHandler : IRequestHandler<GetIssuanceCountQuery, Tuple<long, long, long, long>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly SessionProvider sessionProvider;
        public GetIssuanceCountHandler(IUnitOfWork unitOfWork, SessionProvider sessionProvider)
        {
            this.unitOfWork = unitOfWork;
            this.sessionProvider = sessionProvider;
        }

        public async Task<Tuple<long, long, long, long>> Handle(GetIssuanceCountQuery request, CancellationToken cancellationToken)
        {
            ...
            var entity = unitOfWork.Repository<Entities.Models.Issuance>().GetPagingWhereAsNoTrackingAsync(predicate, null, null, null, null, null);
            int Created = 0;
            if (roles.Contains("Purchase Manager"))
            {
