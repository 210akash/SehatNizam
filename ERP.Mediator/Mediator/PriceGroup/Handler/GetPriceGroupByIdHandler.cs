...
{
    public class GetPriceGroupByIdHandler : IRequestHandler<GetRegionByIdQuery, GetRegion>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly IMapper mapper;

        public GetPriceGroupByIdHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
