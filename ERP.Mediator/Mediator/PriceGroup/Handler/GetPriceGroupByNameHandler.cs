...
{
    public class GetPriceGroupByNameHandler : IRequestHandler<GetRegionByNameQuery, List<GetRegion>>
    {
        private readonly IUnitOfWork unitOfWork;
        private readonly IMapper mapper;

        public GetPriceGroupByNameHandler(IUnitOfWork unitOfWork, IMapper mapper)
        {
