...
{
    public class GetPurchaseOrderCountHandler : IRequestHandler<GetPurchaseOrderCountQuery, Tuple<long, long, long, long, long>>
    {
        ...
        public async Task<Tuple<long, long, long, long, long>> Handle(GetPurchaseOrderCountQuery request, CancellationToken cancellationToken)
        {
            ...
            int Canceled = entity.Item1.Count(item => item.StatusId == 5);
            int Issued = entity.Item1.Count(item => item.StatusId == 20);
            return new Tuple<long, long, long, long,long>(Created, Processed, Approved, Canceled, Issued);
        }
    }
}
