...
namespace ERP.Services.Implementation
{
    ...
    public class AuthService : IAuthService
    {
        ...
        {
            var UserTeam = unitOfWork.Repository<Entities.Models.AspNetUserRoles>().GetFirst(
                y => y.UserId == sessionProvider.Session.LoggedInUserId, null, null, "Role");
            return UserTeam.Role.Name;
        }
