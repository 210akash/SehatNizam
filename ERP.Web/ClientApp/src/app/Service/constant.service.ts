...
toDateTimeLocal(value: string | Date): string {
  ...
  getPolygonDrawProperty(TypeId: number): mapDrawProperty {
    let lObjmapDrawProperty: mapDrawProperty;
    // 1 for Zone, 2 for Territory , 3 For Region, 4 for Area
    switch (TypeId) {
      case 1:
        lObjmapDrawProperty = {
          borderColor: 'green',
    ...
    return lObjmapDrawProperty;
  }

  getPinLocationDrawProperty(TypeId: number): pinLocDrawProperty {
    let lObjpinLocDrawProperty: pinLocDrawProperty;
    // 1 for Distributor, 2 for shop
    switch (TypeId) {
      case 1:
        lObjpinLocDrawProperty = {
          iconFilePath: 'assets/img/distributor.png',
        };
        break;
      case 2:
        lObjpinLocDrawProperty = {
          iconFilePath: 'assets/img/shop.png',
        };
        break;

      default:
        lObjpinLocDrawProperty = {
          iconFilePath: 'assets/img/pin.png',
        };
        break;
    }
    return lObjpinLocDrawProperty;
  }

  public convertDateToMonth(val: any) {
    const date = new Date(val);
