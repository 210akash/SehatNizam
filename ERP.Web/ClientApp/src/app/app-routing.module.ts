...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'admission', component: AdmissionListComponent, canActivate: [AuthGuard] },
      ...
      { path: 'bloodcomponenttype', component: ComponentTypeListComponent, canActivate: [AuthGuard] },
