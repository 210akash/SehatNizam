...
@Component({
  selector: 'app-print-receipt-admission',
  templateUrl: './print-receipt-admission.component.html',
  styleUrls: ['./print-receipt-admission.component.css'],
  standalone: false
})
export class PrintReceiptAdmissionComponent {
  currentUser: any;
  currentDate: any;
  currentTime: any;
  qrCodeUrl = '';
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<PrintReceiptAdmissionComponent>,
