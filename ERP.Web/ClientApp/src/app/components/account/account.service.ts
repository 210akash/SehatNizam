...
export class AccountService extends BaseService<any> {
    ...
    getGroupAccount(categorysFilterForm: any) {
        return this.post(categorysFilterForm, this.endPointControllerName + this.accountEndPoints.getGroupAccount)
            .pipe(map((data: any) => data));
    }
    ...
    getAccountByAccountFlow(_AccountFilter: any) {
        return this.post(_AccountFilter, this.endPointControllerName + this.accountEndPoints.getAccountByAccountFlow)
            .pipe(map((data: any) => data));
    }
}
