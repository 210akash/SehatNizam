...
import { AddBloodFridgeComponent } from '../add-blood-fridge/add-blood-fridge.component';
import { DeleteBloodFridgeComponent } from '../delete-blood-fridge/delete-blood-fridge.component';
import { BloodFridgeService } from '../blood-fridge.service';

@Component({
    selector: 'app-blood-fridge-list',
    templateUrl: './blood-fridge-list.component.html',
    styleUrls: ['./blood-fridge-list.component.css'],
    standalone: false
})
export class BloodFridgeListComponent {
    ...
    openDialog(element: any) {
        this.dialog.open(AddBloodFridgeComponent, { panelClass: 'cstm_width_700', height: 'auto', data: { element }, disableClose: true }).afterClosed().subscribe(() => this.bindData());
    }
    viewDialog(element: any): void {
        this.dialog.open(AddBloodFridgeComponent, { data: { element, isViewMode: true }, panelClass: 'cstm_width_700', height: 'auto', disableClose: true });
    }
    deleteDialog(element: any) {
        this.dialog.open(DeleteBloodFridgeComponent, {
