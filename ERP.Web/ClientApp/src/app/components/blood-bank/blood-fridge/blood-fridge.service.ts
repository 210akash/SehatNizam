...
import { BloodFridgeEndPoints } from './blood-fridge.endpoints';

@Injectable({ providedIn: 'root' })
export class BloodFridgeService extends BaseService<any> {
    endPointControllerName = 'BloodFridge';

    constructor(httpClient: HttpClient, private endpoints: BloodFridgeEndPoints) {
