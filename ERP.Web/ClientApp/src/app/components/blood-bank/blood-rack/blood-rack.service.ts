...
import { BloodRackEndPoints } from './blood-rack.endpoints';

@Injectable({ providedIn: 'root' })
export class BloodRackService extends BaseService<any> {
    endPointControllerName = 'BloodRack';

    constructor(httpClient: HttpClient, private endpoints: BloodRackEndPoints) {
