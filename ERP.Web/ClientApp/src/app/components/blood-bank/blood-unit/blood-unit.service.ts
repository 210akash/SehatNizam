...
import { BloodUnitEndPoints } from './blood-unit.endpoints';

@Injectable({ providedIn: 'root' })
export class BloodUnitService extends BaseService<any> {
    endPointControllerName = 'BloodUnit';

    constructor(httpClient: HttpClient, private endpoints: BloodUnitEndPoints) {
