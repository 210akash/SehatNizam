...
@Component({
    selector: 'app-delete-blood-unit',
    templateUrl: './delete-blood-unit.component.html',
    styleUrl: './delete-blood-unit.component.css',
    standalone: false
})
export class DeleteBloodUnitComponent {
    isLoading = false;
