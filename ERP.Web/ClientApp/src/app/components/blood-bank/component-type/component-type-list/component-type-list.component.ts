...
import { DeleteComponentTypeComponent } from '../delete-component-type/delete-component-type.component';
...
export class ComponentTypeListComponent {
    ...
    openDialog(element: any) {
        this.dialog.open(AddComponentTypeComponent, { panelClass: 'cstm_width_700', height: 'auto', data: { element }, disableClose: true }).afterClosed().subscribe(() => this.bindData());
    }
    viewDialog(element: any): void {
        this.dialog.open(AddComponentTypeComponent, { data: { element, isViewMode: true }, panelClass: 'cstm_width_700', height: 'auto', disableClose: true });
    }
    deleteDialog(element: any) {
        this.dialog.open(DeleteComponentTypeComponent, {
