...
import { BrvListComponent } from '../brv-list/brv-list.component';
import { AddBrvComponent } from '../add-brv/add-brv.component';

@Component({
  selector: 'app-brv-tab',
  templateUrl: './brv-tab.component.html',
  styleUrls: ['./brv-tab.component.css'],
  standalone: false
})

export class BrvTabComponent implements OnInit {
  ...
  @ViewChild(BrvListComponent) transactionListComponent!: BrvListComponent;
  async ngOnInit() {
