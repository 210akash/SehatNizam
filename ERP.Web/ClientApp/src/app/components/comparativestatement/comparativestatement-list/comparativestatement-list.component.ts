...
export class ComparativeStatementListComponent {
  @Output() getcomparativestatementCount: EventEmitter<void> = new EventEmitter<void>();
  ...
  async bindData(comparativestatementFilterForm: any, isFromParent: boolean): Promise<void> {
  ...
  pageChanged(event: PageEvent): void {
    ...
    this.bindData(this.ComparativeStatementFilterForm, false); // Re-fetch data on page change
  }
  ...
  openComparativeStatementDialog(element: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      this.bindData(this.ComparativeStatementFilterForm, false);
      this.getcomparativestatementCount.emit();
    });
  }
