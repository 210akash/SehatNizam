...
export class CityListComponent {
  ...
  async ngOnInit(): Promise<void> {
    this.CityFilterForm = this.formBuilder.group({});
  ...
  async bindData(): Promise<void> {
    ...
    const _CityFilterForm = {
      ...this.CityFilterForm.value,
      PagingData: pagingData
    };

    // Call the service method and subscribe with the observer
    this.cityService.getAllCities(_CityFilterForm).subscribe({
      next: (data: any) => {
  ...
  viewCityDialog(element: any): void {
    this.dialog.open(ViewCityComponent, {
