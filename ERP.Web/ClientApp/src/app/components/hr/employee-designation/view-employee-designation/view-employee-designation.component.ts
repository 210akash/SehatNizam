...
@Component({
    selector: 'app-view-employee-designation',
    templateUrl: './view-employee-designation.component.html',
    styleUrl: './view-employee-designation.component.css',
    standalone: false
})

export class ViewEmployeeDesignationComponent {
