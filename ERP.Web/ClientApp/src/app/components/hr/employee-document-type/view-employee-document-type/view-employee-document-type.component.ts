...
@Component({
    selector: 'app-view-employee-document-type',
    templateUrl: './view-employee-document-type.component.html',
    styleUrl: './view-employee-document-type.component.css',
    standalone: false
})

export class ViewEmployeeDocumentTypeComponent {
