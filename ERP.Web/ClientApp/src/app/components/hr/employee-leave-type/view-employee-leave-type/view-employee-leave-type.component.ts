...
@Component({
    selector: 'app-view-employee-leave-type',
    templateUrl: './view-employee-leave-type.component.html',
    styleUrl: './view-employee-leave-type.component.css',
    standalone: false
})

export class ViewEmployeeLeaveTypeComponent {
