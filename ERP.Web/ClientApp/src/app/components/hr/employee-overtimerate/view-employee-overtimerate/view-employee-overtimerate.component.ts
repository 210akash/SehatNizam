...
@Component({
    selector: 'app-view-employee-overtimerate',
    templateUrl: './view-employee-overtimerate.component.html',
    styleUrl: './view-employee-overtimerate.component.css',
    standalone: false
})

export class ViewEmployeeOvertimeRateComponent {
