...
@Component({
    selector: 'app-view-salarytaxslab',
    templateUrl: './view-salarytaxslab.component.html',
    styleUrl: './view-salarytaxslab.component.css',
    standalone: false
})

export class ViewSalaryTaxSlabComponent {
