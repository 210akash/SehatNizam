...
export class IGPTabComponent implements OnInit {
  ...
  constructor(private iGPService: IGPService, private notificationsService: NotificationsService, private dialog: MatDialog, private constantService: ConstantService, private formBuilder: FormBuilder) { }
  ...
  async changeTab(event: MatTabChangeEvent) {
    ...
    await this.iGPListComponent.bindData(this.lObjLeadsFilterForm);
  }
