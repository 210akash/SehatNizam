...
export class IndentrequestListComponent {
  ...
  async bindData(indentrequestFilterForm: any, currenttab: number, isFromParent: boolean): Promise<void> {
  ...
  pageChanged(event: PageEvent): void {
    ...
    this.bindData(this.IndentrequestFilterForm, this.currenttab, false); // Re-fetch data on page change
  }
