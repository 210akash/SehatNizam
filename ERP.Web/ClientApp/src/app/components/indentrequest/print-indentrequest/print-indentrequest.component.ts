...
@Component({
    selector: 'app-print-indentrequest',
    templateUrl: './print-indentrequest.component.html',
    styleUrl: './print-indentrequest.component.css',
    standalone: false
})

export class PrintIndentrequestComponent {
