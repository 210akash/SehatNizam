...
export class ItemListComponent {
  ...
  displayedColumns: string[] = ['itemType','code','name','unit', 'createdBy','company', 'actions'];
  dataSource: any;
  take = 5;
  totalRows = 0;
  subcategoryList :any;
  ...
  getcategoryList() {
    ...
    this.itemtypeService.getAllItemtypes(_CategoryFilter).subscribe((data: any) => {
  ...
  redirectToitemledger(itemId : any) {
    const url = ''+this.reportsUrl+'ReportServer/Pages/ReportViewer.aspx?%2FERPReports%2FItemLedger&rs%3AClearSession=true&rc%3AView=955b82da-9d4c-41a3-8fd2-995b91d5efd8&CompanyId='+ this.currentUser.department.companyId + '&Item=' + itemId;
