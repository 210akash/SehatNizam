...
export class LocationListComponent {
  ...
  async bindData(): Promise<void> {
    ...
    const _LocationFilterForm = {
      ...this.LocationFilterForm.value,
      PagingData: pagingData
    };

    // Call the service method and subscribe with the observer
    this.locationService.getAllLocations(_LocationFilterForm).subscribe({
      next: (data: any) => {
  ...
  openLocationDialog(element: any) {
  ...
  viewLocationDialog(element: any): void {
    this.dialog.open(ViewLocationComponent, {
  ...
  deleteLocationDialog(element: any) {
