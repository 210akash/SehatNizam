...
import { PJVListComponent } from '../pjv-list/pjv-list.component';

@Component({
  selector: 'app-pjv-tab',
  templateUrl: './pjv-tab.component.html',
  styleUrls: ['./pjv-tab.component.css'],
  standalone: false
})

export class PJVTabComponent implements OnInit {
  ...
  @ViewChild(PJVListComponent) pjvListComponent!: PJVListComponent;
  ...
  async changeTab(event: MatTabChangeEvent) {
    ...
    await this.pjvListComponent.bindData(this.lObjLeadsFilterForm, this.selected.value, true);
  }
