...
@Component({
    selector: 'app-print-purchasedemand',
    templateUrl: './print-purchasedemand.component.html',
    styleUrl: './print-purchasedemand.component.css',
    standalone: false
})

export class PrintPurchaseDemandComponent {
