...
export class PurchaseDemandListComponent {
  @Output() getPurchaseDemandCount: EventEmitter<void> = new EventEmitter<void>();
  ...
  async bindData(purchasedemandFilterForm: any, isFromParent: boolean): Promise<void> {
  ...
  pageChanged(event: PageEvent): void {
    ...
    this.bindData(this.PurchaseDemandFilterForm, false); // Re-fetch data on page change
  }
  ...
  openPurchaseDemandDialog(element: any) {
    ...
    dialogRef.afterClosed().subscribe(result => {
      this.bindData(this.PurchaseDemandFilterForm, false);
      this.getPurchaseDemandCount.emit();
    });
  }

  viewPurchaseDemandDialog(element: any): void {
    const dialogRef = this.dialog.open(ViewPurchaseDemandComponent, {
