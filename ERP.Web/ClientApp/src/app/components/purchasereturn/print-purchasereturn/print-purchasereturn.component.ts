...
@Component({
  selector: 'app-print-purchasereturn',
  templateUrl: './print-purchasereturn.component.html',
  styleUrl: './print-purchasereturn.component.css',
  standalone: false
})

export class PrintPurchaseReturnComponent {
  iGPForm!: FormGroup;
  isLoading = false;
  ...
  for (const detail of details) {
    ...
    totalQty += qty;
    totalamount += qty * (detail.grnDetail?.inspectionDetail?.igpDetail?.purchaseOrderDetail?.unitRate || 0);
  }
