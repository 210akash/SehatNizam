...
@Component({
    selector: 'app-print-salematerial',
    templateUrl: './print-salematerial.component.html',
    styleUrl: './print-salematerial.component.css',
    standalone: false
})

export class PrintSaleMaterialComponent {
  isLoading = false;
  currentUser: any;
  currentDate : any;
  currentTime : any;
  ...
  ngOnInit(): void {
    ...
    console.log(this.data.element.saleMaterialDetail);
    this.calculateTotal();
  }
