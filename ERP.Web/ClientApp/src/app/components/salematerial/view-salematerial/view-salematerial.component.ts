...
@Component({
    selector: 'app-view-salematerial',
    templateUrl: './view-salematerial.component.html',
    styleUrl: './view-salematerial.component.css',
    standalone: false
})

export class ViewSaleMaterialComponent {
  isLoading = false;
