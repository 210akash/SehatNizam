...
@Component({
  selector: 'app-print-salematerialreturn',
  templateUrl: './print-salematerialreturn.component.html',
  styleUrl: './print-salematerialreturn.component.css',
  standalone: false
})

export class PrintSaleMaterialReturnComponent {
  iGPForm!: FormGroup;
  isLoading = false;
  ...
  for (const detail of details) {
    ...
    totalQty += qty;
    totalamount += qty * (detail.saleMaterialDetail?.rate || 0);
  }
