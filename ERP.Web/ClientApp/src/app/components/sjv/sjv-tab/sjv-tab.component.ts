...
import { SJVListComponent } from '../sjv-list/sjv-list.component';

@Component({
  selector: 'app-sjv-tab',
  templateUrl: './sjv-tab.component.html',
  styleUrls: ['./sjv-tab.component.css'],
  standalone: false
})

export class SJVTabComponent implements OnInit {
  ...
  @ViewChild(SJVListComponent) sjvListComponent!: SJVListComponent;
  ...
  async changeTab(event: MatTabChangeEvent) {
    ...
    await this.sjvListComponent.bindData(this.lObjLeadsFilterForm, this.selected.value, true);
  }
